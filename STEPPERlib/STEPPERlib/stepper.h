...
#define _STEPPER1_PIN1			2

#define _STEPPER1_PORT2 			C
#define _STEPPER1_PIN2 			3

#define _STEPPER1_PORT3 			C
#define _STEPPER1_PIN3 			4

#define _STEPPER1_PORT4			C
#define _STEPPER1_PIN4			5
#endif
...
extern uint8_t _stepperStopFlag;													// 1 - emergency stop (for example: too small distance from an obstacle
